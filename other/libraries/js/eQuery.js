(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("eQuery", [], factory);
	else if(typeof exports === 'object')
		exports["eQuery"] = factory();
	else
		root["eQuery"] = factory();
})(this, function() {
...
function isDOMNode(value) {
    return (typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value)) === "object" && value instanceof Element;
}
...
var _weakMap = __webpack_require__(74);

var _weakMap2 = _interopRequireDefault(_weakMap);

var _Attributes = __webpack_require__(61);

var _Attributes2 = _interopRequireDefault(_Attributes);

var _Iteration = __webpack_require__(62);

var _Iteration2 = _interopRequireDefault(_Iteration);

var _Mixin = __webpack_require__(63);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var _NODES = new _weakMap2.default();

var eQuery = function (_mixin) {
    (0, _inherits3.default)(eQuery, _mixin);

    function eQuery(nodes) {
        (0, _classCallCheck3.default)(this, eQuery);

        var _this = (0, _possibleConstructorReturn3.default)(this, (eQuery.__proto__ || (0, _getPrototypeOf2.default)(eQuery)).call(this));

        if (!Array.isArray(nodes)) {
            nodes = [nodes];
        }

        _NODES.set(_this, nodes);

        return _this;
    }

    (0, _createClass3.default)(eQuery, [{
        key: "get",
    ...
    return eQuery;
}((0, _Mixin.mixin)(_Attributes2.default, _Iteration2.default));
...
function findElements(selector) {
    return (0, _from2.default)(document.querySelectorAll(selector));
}

function createElement(htmlTag) {

    var result = /<(.+)>/.exec(htmlTag);
...
var _Check = __webpack_require__(39);
    ...
    css: function css(prop, val) {
        ...
        if (prop !== undefined && val !== undefined) {
            this.each(function (node) {
                return node.style[prop] = val;
            });
        } else if ((0, _Check.isObject)(prop)) {
            var _loop = function _loop(key) {
                _this.each(function (node) {
                    return node.style[key] = prop[key];
                });
            };
...
function mixin() {
    ...
    _assign2.default.apply(Object, [fn.prototype].concat(mixins));

    return fn;
}

function staticMixin(objToMix) {
    for (var _len2 = arguments.length, mixins = Array(_len2 > 1 ? _len2 - 1 : 0), _key2 = 1; _key2 < _len2; _key2++) {
        mixins[_key2 - 1] = arguments[_key2];
    }

    _assign2.default.apply(Object, [objToMix].concat(mixins));
...
var _eQuery = __webpack_require__(59);

var _eQuery2 = _interopRequireDefault(_eQuery);
...
function init(param) {
    ...
    if ((0, _Check.isSelector)(param)) {
        nodes = (0, _Element.findElements)(param);
    } else if ((0, _Check.isHTMLTag)(param)) {
        nodes = (0, _Element.createElement)(param);
    } else if ((0, _Check.isDOMNode)(param)) {
        nodes = param;
    }

    return _eQuery2.default.create(nodes);
}
